...
import pe.Injector;
import pe.core.BootstrapService;
import pe.core.Constants;
import pe.core.User;
import pe.events.UnAuthorizedErrorEvent;
import pe.ui.TextWatcherAdapter;
import pe.util.Ln;
import pe.util.SafeAsyncTask;
...
public class BootstrapAuthenticatorActivity extends ActionBarAccountAuthenticatorActivity {
    ...
    @InjectView(org.sufficientlysecure.viewer.R.id.et_username) protected AutoCompleteTextView emailText;
    @InjectView(org.sufficientlysecure.viewer.R.id.et_password) protected EditText passwordText;
    @InjectView(org.sufficientlysecure.viewer.R.id.b_signin) protected Button signInButton;
    ...
    public void onCreate(Bundle bundle) {
        ...
        //final TextView signUpText = (TextView) findViewById(org.sufficientlysecure.viewer.R.id.tv_signup);
        //signUpText.setMovementMethod(LinkMovementMethod.getInstance());
        //signUpText.setText(Html.fromHtml(getString(org.sufficientlysecure.viewer.R.string.signup_link)));
    }
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        dialog.setMessage(getText(org.sufficientlysecure.viewer.R.string.message_signing_in));
    ...
    public void onAuthenticationResult(final boolean result) {
        if (result) {
            ...
            if (requestNewAccount) {
                ...
                //Toast.makeText(BootstrapAuthenticatorActivity.this,R.string.message_auth_failed_new_account);
            } else {
                Toaster.showLong(BootstrapAuthenticatorActivity.this,
